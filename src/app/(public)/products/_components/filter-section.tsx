"use client"
import { CategoryWithCount, getCategoryWithCount } from "@/lib/server/category-with-count";
...
export default function FilterSection({ categoryWithCount }: { categoryWithCount: CategoryWithCount[] }) {
            ...
            <AnimatePresence mode="popLayout">
                {filterShow && (
                    <motion.div
                        ...
                        className={`col-span-1 content-center bg-white dark:bg-transparent dark:text-neutral-200 px-4 pb-6 shadow rounded overflow-hidden md:w-fit w-full mx-auto inline-block ${filterShow ? "" : "hidden"} md:sticky top-28`}
                    >
                        <motion.div
                            ...
                            <div>
                                ...
                                <motion.div className="space-y-2">
                                    <AnimatePresence>
                                        {categoryWithCountArray?.map((category) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <motion.input
                                                        onChange={(event) => handelChange(event, 'categories')}
                                    ...
                                    <Button
                                        ...
                                        size="sm"
                                        variant="ghost"
                                        className={`border border-neutral-600/60 w-full ${loading ? "cursor-not-allowed" : "cursor-pointer"
                                            }`}
                                        onClick={handelShow}
                                    >
                                        <motion.span
                                            key={isShow ? "less" : "more"}
                                            initial={{ opacity: 0 }}
                                            animate={{ opacity: 1 }}
                                            exit={{ opacity: 0 }}
                                        >
                                    ...
                                    {sizeArray.map((name) => (
                                        ...
                                        >
                                            ...
                                            <label
                                                ...
                                                style={{
                                                    backgroundColor: size === name ? '#yourSelectedColor' : '',
