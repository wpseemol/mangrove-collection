...
export default async function HeroSection() {
        ...
        if (response.success && response.data) {
                ...
                sliderData =
                        data.sliders.length >= 0 ? data.sliders : sliderContent;
