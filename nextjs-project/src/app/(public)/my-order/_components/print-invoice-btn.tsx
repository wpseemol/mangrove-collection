                ...
                <AlertDialogHeader className="">
                    ...
                    >
                        ...
                        <div className="invoice-section">
                            ...
                            <p>
                                <strong>Customer:</strong> {data.address.name}
                            </p>
                            {data.address.email && (
                                <p>
                                    <strong>Email:</strong> {}
                            ...
                            <p>
                                <strong>Phone:</strong> {data.address.phone}
                            </p>
                            <p>
                        ...
                        <div className="invoice-total">
                            <p>
                                Subtotal: ৳
                                {(data.totalAmount - data.shippingCost).toFixed(
                                    2,
                                )}
                            </p>
                        ...
                        {data.paymentStatus !== "completed" && (
                            <div className="invoice-watermark">UNPAID</div>
                        )}
                    </div>
                </AlertDialogHeader>
