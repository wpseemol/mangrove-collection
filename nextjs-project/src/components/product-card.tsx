                ...
                <CardContent className="h-fit p-0 w-full">
                    <Link href={`/products/${details.slug}`}>
                        ...
                        <div className="animate-fade-up animate-once animate-duration-1000 w-full px-2 mt-1 flex flex-col items-center">
                            <h2 className="max-h-[75px] overflow-hidden font-normal md:text-lg text-base text-ellipsis text-center group-hover:text-primary-foreground capitalize group-hover:underline duration-150">
