        ...
        <li className={``}>
            ...
            {menuShow.status && (
                <motion.ul
                    ...
                    className={`fixed top-[4.8rem] z-50 left-0 border rounded-sm text-xl font-normal text-secondary-foreground min-w-[calc(100vw-8rem)] min-h-[calc(100vh-4.8rem)] bg-gray-100  `}
                    onAnimationComplete={() => {
                        if (!menuShow.animation) {
                            setMenuShow({
                                animation: false,
