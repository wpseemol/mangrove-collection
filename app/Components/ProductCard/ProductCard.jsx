...
export default function ProductCard({ productDetails }) {
    ...
    return (
        <div className="border border-neutral-300/30 group hover:shadow-lg duration-300 sm:w-64 mx-3 max-w-72 relative h-[23rem] overflow-hidden animate-jump-in animate-fill-both">
            <Link href={slugUrl}>
